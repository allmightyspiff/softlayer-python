...
class SoftLayer_Network_Storage_Allowed_Host_VirtualGuest(object):

    def __init__(self, client: Client) -> None:
        self.service = 'SoftLayer_Network_Storage_Allowed_Host_VirtualGuest'
        self.client = client
# This file was automatically generated with tools/generateTypes.py
    def getObject(
        self,
        ...
        from SoftLayer.datatypes.Network.Storage.Allowed.Host.VirtualGuest import VirtualGuest
        return SL_VirtualGuest(data)
