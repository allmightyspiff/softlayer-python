...
class SoftLayer_Network_Storage_Group_Nfs(object):

    def __init__(self, client: Client) -> None:
        self.service = 'SoftLayer_Network_Storage_Group_Nfs'
        self.client = client
    ...
    def getObject(
        ...
        from SoftLayer.datatypes.Network.Storage.Group.Nfs import Nfs
        return Nfs(data)
