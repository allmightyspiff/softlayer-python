...
class Container_Product_Order_Network_Storage_Backup_Evault_Vault(Container_Product_Order):
    """This is the datatype that needs to be populated and sent to SoftLayer_Product_Order::placeOrder. This
datatype has everything required to place an Evault order with SoftLayer."""
