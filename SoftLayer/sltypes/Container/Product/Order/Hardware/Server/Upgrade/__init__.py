...
class Container_Product_Order_Hardware_Server_Upgrade(Container_Product_Order_Hardware_Server):
    """This is the datatype that needs to be populated and sent to SoftLayer_Product_Order::placeOrder. This
datatype has everything required to place a hardware upgrade."""
