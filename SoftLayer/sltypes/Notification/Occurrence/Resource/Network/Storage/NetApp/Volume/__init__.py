...
class Notification_Occurrence_Resource_Network_Storage_NetApp_Volume(Notification_Occurrence_Resource):
    """This type contains general information related to a [[SoftLayer_Network_Storage]] resource that is impacted
